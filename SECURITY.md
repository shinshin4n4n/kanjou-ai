...
- **Supabase Auth** によるメール/パスワード認証（Google OAuth 対応予定）
...
セキュリティに関する問題を発見した場合は、[GitHub Security Advisories](https://github.com/shinshin4n4n/kanjou-ai/security/advisories/new) から非公開で報告してください。公開 Issue での報告はお控えください。
